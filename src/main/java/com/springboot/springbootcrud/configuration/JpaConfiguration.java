package com.springboot.springbootcrud.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.springboot.springbootcrud.repositories",
...
public class JpaConfiguration {
    ...
    */
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.springboot.springbootcrud.model" });
